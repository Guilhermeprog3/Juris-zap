    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
      ...
      <section className="relative bg-gradient-to-br from-emerald-100 to-teal-100 py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="mt-4 text-sm text-gray-600">Teste grátis por 7 dias no plano Essencial. Cancele quando quiser.</p>
      ...
      <section className="bg-gradient-to-br from-emerald-700 to-teal-700 py-20 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8 max-w-2xl mx-auto">
            Comece seu teste gratuito de 7 dias no plano Essencial. Junte-se a milhares de estudantes que já usam JurisZap para dominar o Direito.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/cadastro">
