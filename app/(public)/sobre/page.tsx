...
import { Mail, Linkedin, Briefcase, Bot } from "lucide-react"
import Image from "next/image"

// --- Dados dos Criadores ---
const creators = [
  {
    name: "Nome do CEO & Desenvolvedor",
    role: "CEO & Desenvolvedor Full-Stack",
    isDeveloper: true,
    portfolioUrl: "#", // Coloque o link do portfólio aqui
    imageUrl: "/placeholder-user.jpg", // Caminho para a foto no public/
    contact: {
      email: "mailto:desenvolvedor@email.com",
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow">
        {/* SEÇÃO SOBRE O JURISZAP - REESTILIZADA */}
        ...
        {/* SEÇÃO DOS CRIADORES - REESTILIZADA */}
